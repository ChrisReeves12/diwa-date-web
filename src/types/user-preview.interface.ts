...
export type UserPreview = Pick<User, 'displayName' | 'photos' | 'publicPhotos'
    ...
    & { id: number, blockedThem?: boolean, matchStatus?: string, matchAcceptedAt?: string, matchId?: number, theyLikedMe?: boolean, lastActiveHumanized?: string, receivedLikeHumanized?: string }
