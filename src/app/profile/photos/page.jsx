...
const photos_management_1 = require("./photos-management");
            ...
            <site_wrapper_1.default>
                <div className="profile-settings-container">
                    <div className="container">
                        ...
                        <profile_settings_tabs_1.ProfileSettingsTabs selectedTab="photos"/>
                        <photos_management_1.PhotosManagement currentUser={currentUser}/>
                    </div>
                </div>
            </site_wrapper_1.default>
